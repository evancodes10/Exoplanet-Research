...
def kepler10_dataframe(subset="all"):
    ...
    def build_lightcurve_df():
        ...
        lc_collection = lk.search_lightcurve("Kepler-10", mission="Kepler", cadence="long", author="Kepler").download_all()
        lc_collection = lk.LightCurveCollection([lc.select_flux("pdcsap_flux") for lc in lc_collection])  # add this
